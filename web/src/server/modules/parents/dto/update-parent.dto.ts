...
import { ParentUpdateRequest } from '@school-bus-tracking/shared-types';
...
/** Body of `PATCH /api/v1/parents/:id`. */
export class UpdateParentDto implements ParentUpdateRequest {
  @IsOptional()
