...
export const hi: Dictionary = {
  ...
  'trip.kids.title': 'अगले स्टॉप के बच्चे',
  'trip.kids.count.one': '{count} बच्चा',
  'trip.kids.count.other': '{count} बच्चे',
  ...
  'map.exploringA11y': 'नक्शा देख रहे हैं — फ़ॉलो रुका है',
  'map.status.live': 'लाइव स्थिति',
  'map.status.lastKnown': 'अंतिम ज्ञात',
  'map.status.noLocation': 'स्थिति नहीं',
  'map.status.approximate': 'अनुमानित',
  ...
  'datePicker.selectMonth': 'महीना चुनें',
  'datePicker.selectYear': 'वर्ष चुनें',
  'datePicker.previousMonth': 'पिछला महीना',
  'datePicker.nextMonth': 'अगला महीना',
  'datePicker.previousYear': 'पिछला वर्ष',
  'datePicker.nextYear': 'अगला वर्ष',
  'date.month.1': 'जनवरी',
  'date.month.2': 'फ़रवरी',
  'date.month.3': 'मार्च',
  'date.month.4': 'अप्रैल',
