...
export const hi: Dictionary = {
  ...
  'error.HTTP_500': 'सर्वर रिक्वेस्ट पूरी नहीं कर सका (HTTP 500)। थोड़ी देर में फिर कोशिश करें।',
  'error.HTTP_503': 'सर्वर रिक्वेस्ट पूरी नहीं कर सका (HTTP 503)। थोड़ी देर में फिर कोशिश करें।',
