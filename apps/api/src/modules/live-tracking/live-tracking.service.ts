...
export class LiveTrackingService {
  constructor(
    @Inject(LIVE_TRACKING_REPOSITORY)
    private readonly locations: typeof TripLocation,
    @Inject(LIVE_TRACKING_TRIPS_REPOSITORY)
    private readonly trips: typeof Trip,
    @Inject(LIVE_TRACKING_ASSIGNMENTS_REPOSITORY)
    private readonly assignments: typeof RouteAssignment,
    @Inject(LIVE_TRACKING_STUDENTS_REPOSITORY)
    private readonly students: typeof Student,
    @Inject(LIVE_TRACKING_STOPS_REPOSITORY)
    private readonly stops: typeof Stop,
    @Inject(LIVE_TRACKING_GUARDIANS_REPOSITORY)
