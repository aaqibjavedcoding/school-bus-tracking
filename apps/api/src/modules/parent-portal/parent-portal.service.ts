...
export class ParentPortalService {
  constructor(
    @Inject(PARENT_PORTAL_GUARDIANS_REPOSITORY)
    private readonly guardians: typeof StudentGuardian,
    @Inject(PARENT_PORTAL_STUDENTS_REPOSITORY)
    private readonly students: typeof Student,
    @Inject(PARENT_PORTAL_STOPS_REPOSITORY)
    private readonly stops: typeof Stop,
    @Inject(PARENT_PORTAL_ROUTES_REPOSITORY)
    private readonly routes: typeof Route,
    @Inject(PARENT_PORTAL_BUSES_REPOSITORY)
    private readonly buses: typeof Bus,
    @Inject(PARENT_PORTAL_TRIPS_REPOSITORY)
    private readonly trips: typeof Trip,
    @Inject(PARENT_PORTAL_USERS_REPOSITORY)
    private readonly users: typeof User,
    @Inject(PARENT_PORTAL_SCHOOLS_REPOSITORY)
