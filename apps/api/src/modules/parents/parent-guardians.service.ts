...
export class ParentGuardiansService {
  constructor(
    @Inject(PARENTS_REPOSITORY) private readonly parents: typeof User,
    @Inject(PARENTS_STUDENTS_REPOSITORY) private readonly students: typeof Student,
    @Inject(STUDENT_GUARDIANS_REPOSITORY)
