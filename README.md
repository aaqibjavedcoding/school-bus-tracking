...
| [`marketing/README.md`](./marketing/README.md)                                                     | **Launch campaign copy (not product code)** — 11 video scripts with timings + narration, AI-video prompts, Instagram/LinkedIn captions + posting calendar, `.srt` subtitles, and the client-facing feature brief & pilot plan                                                                                                                                                                                                                                                                                                         |
